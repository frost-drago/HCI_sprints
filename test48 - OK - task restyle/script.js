...
function new_tasklist_item(input_task_name, input_task_difficulty, input_task_impact, input_task_description, input_color) {
    ...
    const new_delete_image = document.createElement('img')
    new_delete_image.src = "images/close.png"
    new_task_delete_button.appendChild(new_delete_image)
    ...
    new_task_difficulty_capsule.textContent = 'D:'
    ...
    new_task_impact_capsule.textContent = "I:"
